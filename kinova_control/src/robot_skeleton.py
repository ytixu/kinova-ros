...
links =  ['j2n6s300::root', 'j2n6s300::j2n6s300_link_1', 'j2n6s300::j2n6s300_link_2', 'j2n6s300::j2n6s300_link_3', 'j2n6s300::j2n6s300_link_4', 'j2n6s300::j2n6s300_link_5', 'j2n6s300::j2n6s300_link_6', 'j2n6s300::j2n6s300_link_finger_1', 'j2n6s300::j2n6s300_link_finger_2', 'j2n6s300::j2n6s300_link_finger_3']
THRSH = 0.11
...
class robot_recorder:
	def __init__(self):
		...
		self.joint_state_sub =rospy.Subscriber('/j2n6s300/joint_states', JointState, self.record_messages)
	...
	def record_messages(self, joint_states):
		...
		if np.linalg.norm(pose_mat - self.record_pose) > THRSH:
...
# rosbag record /collision_object /gazebo/link_states /j2n6s300/joint_states